...
*/
degerlendirmeler.forEach(item,index)=>{
	if(item.isim ==="Reyna") {
		item.geribildirim=`${index}:bu mekan bir harika dostum, yine de garsonun gülümsememesinden puan kırdım`;
	}
}
